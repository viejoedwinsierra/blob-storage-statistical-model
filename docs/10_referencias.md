...
⬅️ [Anterior](09_modelo_causal_fallas.md)

---

# 10. Referencias

## Sistemas distribuidos y procesamiento de datos
...
## Duplicación de datos y almacenamiento

- Meyer, D. T., & Bolosky, W. J. (2011). *A Study of Practical Deduplication*. ACM Transactions on Storage, 7(4).

- Douglis, F., Li, J., Patterson, H., & Iyengar, A. (2004). *Design and Evaluation of Content-Based Deduplication Systems*. IBM Research Report.
